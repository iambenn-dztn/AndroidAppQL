 ...
 * Use the {@link nhaphang_frag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class nhaphang_frag extends Fragment {

    RecyclerView rcvTask1,rcvTask2;
    LinearLayout tasknhapShow;
    TextView tvDemNhap;
    private View v;
    ImageView imgNhap;
    SearchView searchView;
    Button btnnhap;
    TaskNhapAdapter taskNhapAdapter1;
    TaskNhapAdapter taskNhapAdapter2;
...
//    DataBase database;
     ...
     * @return A new instance of fragment nhaphang_frag.
     */
    // TODO: Rename and change types and number of parameters
    public static nhaphang_frag newInstance(String param1, String param2) {
        nhaphang_frag fragment = new nhaphang_frag();
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.menu_search_nhap,menu);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.fragment_nhaphang_frag, container, false);
        rcvTask1=v.findViewById(R.id.rcv_tasknhap1);
        rcvTask2=v.findViewById(R.id.rcv_tasknhap2);
        tasknhapShow=v.findViewById(R.id.tasknhap_show);
        tvDemNhap=v.findViewById(R.id.tv_demnhap);
        imgNhap=v.findViewById(R.id.imgNhap);
...
//Bat su kien nut Nhap hang
        btnnhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(getContext(), DonNhapActivity.class);
    ...
    public void setDataTask1() {
        ...
        taskNhapAdapter1=new TaskNhapAdapter();
    ...
    public void setDataTask2() {
        ...
        taskNhapAdapter2=new TaskNhapAdapter();
    ...
    public void showOrHiddenTask() {
        if (listTask2!=null && listTask2.size()>0) {
            ...
            tasknhapShow.setVisibility(View.VISIBLE);
            tvDemNhap.setText(String.valueOf(listTask2.size()));
            imgNhap.setImageResource(R.drawable.ic_baseline_keyboard_arrow_down_24);
        } else {
            btnnhap.setEnabled(false);
            tasknhapShow.setVisibility(View.VISIBLE);
            tvDemNhap.setText(String.valueOf(listTask2.size()));
            imgNhap.setImageResource(R.drawable.ic_baseline_keyboard_arrow_right_24);
        }

        tasknhapShow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(isExpand==true) {
                    isExpand=false;
